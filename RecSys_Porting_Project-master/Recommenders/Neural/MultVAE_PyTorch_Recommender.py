...
class _Encoder(torch.nn.Module):
    ...
    def __init__(self, options, dropout_p=0.5, q_dims=None):
        ...
        # self.linear_1 = torch.nn.Linear(self.q_dims[0], self.q_dims[1], bias=True)
        # self.linear_2 = torch.nn.Linear(self.q_dims[1], self.q_dims[2] * 2, bias=True)
...
class _Decoder(torch.nn.Module):
    def __init__(self, options, p_dims=None):
        ...
        # self.linear_1 = torch.nn.Linear(self.p_dims[0], self.p_dims[1], bias=True)
        # self.linear_2 = torch.nn.Linear(self.p_dims[1], self.p_dims[2], bias=True)
        # self.tanh = torch.nn.Tanh()
...
class _MultiVAEModel(torch.nn.Module):
    ...
    def get_l2_reg(self):
        ...
        # return sum([torch.norm(p, p=2) ** 2 for p in self.parameters()])
