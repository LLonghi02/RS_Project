...
class Incremental_Training_Early_Stopping(object):
    ...
    def _train_with_early_stopping(self, epochs_max, epochs_min = 0,
                                   validation_every_n = None, stop_on_validation = False, max_total_time = None,
        ...
        if max_total_time is not None:
            max_time_value, max_time_unit = seconds_to_biggest_unit(max_total_time)
        ...
        while epochs_current <= epochs_max and not convergence:
            ...
            # Determine whether a validation step is required
            ...
            if max_total_time is not None and elapsed_time >= max_total_time:
                print("{}: Total training time is {:.2f} {}, exceeding the maximum threshold of {:.2f} {}".format(algorithm_name, new_time_value, new_time_unit, max_time_value, max_time_unit))
                convergence = True
